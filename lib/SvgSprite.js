...
class SvgSprite {
    ...
    constructor(resourcePath) {
        ...
        this.originalResourcePathRegExp = new RegExp(escapeRegExp(resourcePath), 'gm');
        this.previousResourcePath = null;
        this.previousResourcePathRegExp = null;
        this.resourcePath = this.originalResourcePath;
        this.resourcePathRegExp = this.originalResourcePathRegExp;
        this.icons = {};
        this.updated = false;
        this.dirty = false;
    }
     ...
     * @return {string}
     */
    replaceSpritePathInModuleSource(input) {
        ...
        input = input.replace(originalResourcePathRegExp, resourcePath);

        if (resourcePath !== previousResourcePath) {
            input = input.replace(previousResourcePathRegExp, resourcePath);
        }
